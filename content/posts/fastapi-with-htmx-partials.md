...
![Movies initial page](/images/movies-no-table.png 'Movies initial page')
...
![Movies table HTML partial loaded correctly with HTMX](/images/movies-table.png 'Movies table HTML partial loaded correctly with HTMX')
...
![Movies table HTML partial loaded with no styling](/images/movies-partial-loaded.png 'Movies table HTML partial loaded with no styling')
